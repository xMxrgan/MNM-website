    ...
    <>
      <div className="info-container">
        ...
        <div className="description">
          ...
          centro dedicato a tutte le persone fragili, affette da demenza o
          decadimento cognitivo.
          <br />
          Volontari formati, affiancati da professionisti esperti, conducono
          incontri, con una frequenza di tre incontri a settimana a Bovolone e
          quattro incontri fissi a settimana a Concamarise, finalizzati a
            ...
            <div className="dove-siamo-container">
              ...
              <div className="address-container">
                ...
                <div className="address-details">
                  <h3>Bovolone</h3>
                  <p>
                    Via Lino Turrini, Villa Panteo Zampieri
                    <br />
                    37051, Bovolone VR
                  </p>
                </div>
