        ...
        <>
            ...
            <div className="DChome-container">
                <div className="DChome-pic">
                    <a href={WelcomeSeptember} target="_blank" rel="noopener noreferrer">
                        <img src={WelcomeSeptember} style={{ maxWidth: "100%", height: "auto" }} />
                    </a>
                </div>
                ...
                <h3>
                    ...
                    <br />
                    <a href="mailto:info@dailycenter.it">info@dailycenter.it</a>
                </h3>
            </div>
        </>
    );
